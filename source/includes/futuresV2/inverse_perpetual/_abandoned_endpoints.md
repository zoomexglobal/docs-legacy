...
```console
curl https://openapi-testnet.zoomex.com/v2/public/liq-records?symbol=BTCUSD
```
...
```console
curl "https://openapi-testnet.zoomex.com/user/leverage?api_key={api_key}&timestamp={timestamp}&sign={sign}"
```
...
```console
curl "https://openapi-testnet.zoomex.com/open-api/order/list?api_key={api_key}&timestamp={timestamp}&sign={sign}&symbol=BTCUSD"
```
...
```console
curl "https://openapi-testnet.zoomex.com/open-api/stop-order/list?api_key={api_key}&timestamp={timestamp}&sign={sign}"
```
...
```console
curl https://openapi-testnet.zoomex.com/open-api/stop-order/create \
...
```console
curl https://openapi-testnet.zoomex.com/open-api/stop-order/cancel \
-H "Content-Type: application/json" \
...
```console
curl https://openapi-testnet.zoomex.com/open-api/stop-order/replace \
-H "Content-Type: application/json" \
...
```console
curl https://openapi-testnet.zoomex.com/open-api/order/replace \
-H "Content-Type: application/json" \
-d '{"api_key":"{api_key}","symbol":"BTCUSD","order_id":"","timestamp":{timestamp},"sign":"{sign}"}'
```
...
```console
curl "https://openapi-testnet.zoomex.com/open-api/wallet/risk-limit/list?api_key={api_key}&timestamp={timestamp}&sign={sign}"
```
...
```console
curl https://openapi-testnet.zoomex.com/open-api/wallet/risk-limit \
-H "Content-Type: application/json" \
